...
class Categorie(models.Model):
    ...
    category = models.CharField(max_lenght=30, verbose_name="Category")
...
class Plant(models.Model):
    ...
    plant_name = models.CharField(max_lenght=30, verbose_name="Plant Name")
    care = models.CharField(max_lenght=1000, verbose_name="Care")
